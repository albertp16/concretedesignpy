...
def index():
    ...
    calculators = [
        ...
        {"id": "beam-shear", "name": "Beam Shear Design",
         "desc": "Concrete and steel shear strength",
         "category": "Beam"},
        ...
        {"id": "beam-deflection", "name": "Beam Deflection",
         ...
         "category": "Beam"},
        {"id": "column-interaction", "name": "Column Interaction Diagram",
         "desc": "P-M interaction diagram generation",
         "category": "Column"},
        ...
        {"id": "mander", "name": "Mander Confined Concrete",
         ...
         "category": "Material"},
        {"id": "frp-beam", "name": "FRP Beam Strengthening",
         "desc": "FRP flexural strengthening per ACI 440",
         "category": "FRP"},
        ...
        {"id": "moment-curvature", "name": "Moment-Curvature",
         ...
         "category": "Analysis"},
        {"id": "rebar-layout", "name": "Rebar Layout",
         "desc": "Rebar coordinates for rectangular sections",
         "category": "Section"},
